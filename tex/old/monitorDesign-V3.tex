...
\todo[inline]{More multigrid refs?}
...
{\bf needs work}
% and define its monitor functions. In section \ref{sec:Dynamic} we briefly outline the two methods for combining two different PDEs governing the imaging technique and the dynamic motion, and present the adaptive design algorithms.  
...
\label{sec:Noisy}
\todo[inline]{I'm assuming you want to redo this whole section?}
